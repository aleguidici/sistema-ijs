        ...
        // Append table with add row form on add new button click
          $(".add-new").click(function(){
            ...
            var row = '<tr>' +
                ...
                '<td><select class="form-control" id="sector" name="sector" onchange="javascript:valor()"><option value="0">Tablero principal</option><option disabled style="font-style:italic">&nbsp;&nbsp;&nbsp;─────────────────────&nbsp;&nbsp;&nbsp;</option><option value="100">Tablero de transferencia</option><option value="1">Gerencia</option><option value="2">Cajeros</option><option value="3">Caja</option><option value="4">Atención al cliente</option><option value="5">Oficinas</option><option value="6">Cocina</option><option value="7">Oficina de seguridad</option><option value="8">Sala de tableros</option><option value="9">Sala de usos múltiples</option><option value="10">Habitaciones</option><option value="11">Taller</option> <option value="12">Terminales autoserv.</option><option value="13">Baños</option><option value="14">Depósito</option><option value="15">Sala de estar</option><option value="16">Sala de mantenim.</option><option value="17">Sala de juegos</option><option value="18">Salón tragamonedas</option><option value="19">Otro</option><option value="20">Tablero Seccional Caldera</option><option value="21">Tablero Estabilizador</option><option value="22">Tablero Descargador Sobretension</option><option value="23">Tablero Iluminación General</option><option value="24">Tablero Seccional Baño y Oficina</option><option value="25">Surtidores</option><option value="26">Dispenser Agua</option><option value="27">Pasillo</option><option value="28">Bunker</option><option value="29">Sala de datos</option><option value="30">Tablero Seccional Embarque</option></select></td>' +
                '<td><select class="form-control" id="descripcion_terreno" name="descripcion_terreno"><option value="">Lecho seco</option><option value="">Arcilloso</option><option value="">Pantanoso</option><option value="">Lluvias recientes</option><option value="">Arenoso seco</option><option value="">Arenoso húmedo</option><option value="">Arcilloso húmedo</option><option value="">Laterítica húmeda</option><option value="">Árido seco</option><option value="">Árido húmedo</option><option value="">Otro</option></select></td>' +
