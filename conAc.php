    ...
    <div>
      <div class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn btn-info active">
          <input type="radio" name="options" id="option1" autocomplete="off" onchange="javascript:minTablaMaquinas();" checked>Reparaciones <span class="glyphicon glyphicon-wrench"> </span>
        </label>
        <label class="btn btn-info">
          <input type="radio" name="options" id="option2" autocomplete="off" onchange="javascript:fullTablaMaquinas();"> <span class="glyphicon glyphicon-usd"> </span> Venta de repuestos 
        </label>
      </div>
    </div>
    <hr style="border-top: 0.1px solid #DDDDDD;">
