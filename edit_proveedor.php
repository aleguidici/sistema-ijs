...
?>
<?php
  $prov = find_by_id('proveedor',(int)$_GET['id']);
  if(!$prov){
 ...
 if(isset($_POST['abm_proveedor'])){
   ...
   validate_fields($req_field); 
      ...
      if(empty($errors)){ 
        ...
        if($tel2 === '0' || $tel2 === '')
          $tel2 = '';
        $query = "UPDATE proveedor SET  razon_social='{$razon_social}', cuit='{$cuit}', direccion='{$direccion}', localidad='{$localidad}', provincia='{$provincia}', cp='{$cp}', telefono1='{$tel1}', telefono2='{$tel2}', iva='{$cond_IVA}' WHERE id = '{$prov['id']}'";  
      ...
      <div class="panel panel-default">
       <div class="panel-heading">
        ...
        <div class="panel-body">
          <form method="post" action="edit_proveedor.php?id=<?php echo (int)$prov['id'];?>">
              ...
              <div class="form-group  col-xs-3  ">
                  <button type="submit" name="abm_proveedor" class="btn btn-primary">Editar Proveedor</button>
              </div>
          </form>
        </div>
      </div>
