          ...
          <?php foreach($all_users as $a_user): ?>
            <tr>
              ...
              <td class="text-center">
                <?php 
                $status = find_by_groupLevel2($a_user['user_level']);
                if ($status['group_status'] === '1') {
                  if($a_user['status'] === '1') { ?>
              ...
              <td class="text-center">
                <div class="btn-group">
                  ...
                  <a href="delete_user.php?id=<?php echo (int)$a_user['id'];?>" class="btn btn-xs btn-danger"  title="Eliminar" data-toggle="tooltip" onclick="return confirm('¿Seguro que desea eliminar este usuario?')">
