    ...
    <div class="col-md-10">
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="row">
            <div class="col-md-10">
              <button hidden id="btn_sumar-cotizacion" onclick="sumarMontoCotizacion('<?php echo $estaReparacion['id']; ?>','<?php echo $sumaTotal;?>','<?php echo $estaReparacion['senia']; ?>');"></button>
                ...
                <tr>
                  <?php
                    if ($cotizacionReparacion) { ?>                      
                      ...
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" name="mano_obra" id="mano_obra" value="<?php echo $cotizacionReparacion['mano_obra'];?>" maxlength="8" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" min="0" name="grasa" id="grasa" value="<?php echo $cotizacionReparacion['grasa'];?>" maxlength="10" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" min="0" name="flete" id="flete" value="<?php echo $cotizacionReparacion['flete'];?>" maxlength="10" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><input type="number" min="0" max="1000" name="recargo" id="recargo" value="<?php echo $cotizacionReparacion['recargo'];?>" disabled=""><?php echo " %";?></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ ".$estaReparacion['senia']; ?></td>
                      <td style="vertical-align:middle; width: 14.5%;" class="text-center"><label name="input_totales" id="input_totales"></label></td>
                      <script> document.getElementById('input_totales').innerHTML = "<?php echo '$ '.$cotizacionReparacion['total'] ;?>" ; </script>
                    <?php } else { ?>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ ".$sumaTotal ?></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" name="mano_obra" id="mano_obra" value="<?php echo $cotizacionBase['mano_obra'];?>" maxlength="8" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" min="0" name="grasa" id="grasa" value="<?php echo $cotizacionBase['grasa'];?>" maxlength="10" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ "?><input type="number" min="0" name="flete" id="flete" value="<?php echo $cotizacionBase['flete'];?>" maxlength="10" disabled></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><input type="number" min="0" max="1000" name="recargo" id="recargo" value="<?php echo $cotizacionBase['recargo'];?>" disabled=""><?php echo " %";?></td>
                      <td style="vertical-align:middle; width: 14.25%;" class="text-center"><?php echo "$ ".$estaReparacion['senia']; ?></td>
                      <td style="vertical-align:middle; width: 14.5%;" class="text-center"><label name="input_totales" id="input_totales"></label></td>
                  <?php } ?>
                </tr>                             
  ...
  ?>
        ...
        window.onload = function() {
          ...
          if (reloading) {
            ...
            sumarMontoCotizacion('<?php echo $estaReparacion['id']; ?>','<?php echo $sumaTotal;?>','<?php echo $estaReparacion['senia']; ?>');
          }
        }
        </script>     
