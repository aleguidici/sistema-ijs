<?php
  ...
  $repuestoExist = $db->fetch_assoc($db->query("SELECT `id` FROM `maquina_repuesto` WHERE ( `id_modelo` = '".$idModelo."' AND `parte` = '".$parte."' ) OR ( `id_modelo` = '".$idModelo."' AND `codigo` = '".$codigo."') LIMIT 1"));
  if (!$repuestoExist) {
