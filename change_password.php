...
<?php
  if(isset($_POST['update'])){
    ...
    $req_fields = array('new-password', 'new-passwordR','old-password','id' );
    ...
    if(empty($errors)){
            ...
            if($_POST['new-password'] !== $_POST['new-passwordR'] ){
               $session->msg('d', "Debe ingresar la misma contraseña nueva");
               redirect('change_password.php',false);
            }
    ...
    <div class="text-center">
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="change_password.php" class="clearfix">
        ...
        <div class="form-group">
              <label for="newPasswordR" class="control-label">Repita nueva contraseña</label>
              <input type="password" class="form-control" name="new-passwordR" placeholder="Nueva contraseña">
        </div>
