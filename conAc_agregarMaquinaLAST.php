<?php
  ...
  if(isset($_POST['abm_cliente'])){
   ...
   $descripcionFinalLower = remove_junk($db->escape($_POST['descripcionFinal']));
...
<div class="panel panel-default" id="panelcito">
  ...
  <div class="panel-body">
    ...
    <form method="post" action="conAc_agregarMaquina.php"> 
      ...
      <div class="row">
        <div class="form-group col-md-4">
          <label for="telefono" class="control-label">Descripción de la máquina (Opcional):</label>
