      ...
      if (sumaRepuestos >= 0) {
        ...
        if (recargo <= 1000) {
          if (completo == 1) {
            ...
            subTotal = (parseFloat(acumRecargo) + parseFloat(grasa) + parseFloat(mano_obra) + parseFloat(flete) - parseFloat(senia)).toFixed(2);
            ivaFinal = parseFloat(subTotal * 0.21).toFixed(2) ;
            totalFinal = (parseFloat(subTotal) + parseFloat(ivaFinal)).toFixed(2) ;
...
<form method="post"> 
  ...
  <div class="row">
    ...
    $totalFinal = round($cotizacionReparacion['subtotal'] + $ivaFinal, 2);
    ?>
                ...
                <tr>
                  <?php
                    if ($cotizacionReparacion) { ?>                      
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><?php echo "$ ".$subTotal ?></td>
                      ...
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><?php echo "$ ".$estaReparacion['senia']; ?></td>
                    ...
                    <?php } else { ?>
                      ...
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><input type="number" min="0" max="1000" name="recargo" id="recargo" value="<?php echo $cotizacionBase['recargo'];?>" disabled=""><?php echo " %";?></td>
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><?php echo "$ ".$estaReparacion['senia']; ?></td>
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><label name="input_subtotal" id="input_subtotal"></label></td>
                      <td style="vertical-align:middle; width: 11%;" class="text-center"></td>
                      <td style="vertical-align:middle; width: 12%;" class="text-center"><</td>
                  <?php } ?>
                </tr>                             
              </tbody>
            </table>
