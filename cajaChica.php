...
<script>
    ...
    datasets: [
      {
        ...
        data                : [
                                <?php
                                  ...
                                  foreach ($allCajasById as $unaCajaById) :
                                    $sql_allIngresosEver = $db->query("SELECT * FROM caja_ingresos WHERE caja_id='".$unaCajaById['id']."'");
                                    $allIngresosEver = $db->while_loop($sql_allIngresosEver);   
                                    foreach ($allIngresosEver as $unIngresoEver) :
                                      list($yearControl, $monthControl, $dayControl) = explode('-', $unaCajaById['fecha_inicio']);
      ...
      },
      {
        ...
        data                : [
                              <?php
                                  ...
                                  foreach ($allCajasById as $unaCajaById) :
                                  $sql_allEgresosEver = $db->query("SELECT * FROM caja_egresos WHERE caja_id='".$unaCajaById['id']."'");
                                  $allEgresosEver = $db->while_loop($sql_allEgresosEver);  
    ...
    datasets: [
      {
        ...
        data                : [
                                <?php
                                  ...
                                  $sumaGLPADiciembre = 0;
                                  foreach ($allCajasById as $unaCajaById) :
                                    $sql_allCombustibleEver = $db->query("SELECT * FROM caja_egresos WHERE caja_id='".$unaCajaById['id']."'");
                                    $allCombustibleEver = $db->while_loop($sql_allCombustibleEver); 
  ...
  var donutChart = new Chart(donutChartCanvas, {
    ...
    var temp2 = {
        label               : 'Fondo inicial',
        backgroundColor     : /*'rgba(60,141,188,0.9)'*/'rgba(255,225,70,0.9)',
        borderColor         : 'rgba(255,225,70,0.9)',
        pointRadius         : false,
        pointColor          : '#3b8bba',
        pointStrokeColor    : 'rgba(255,225,70,1)',
        pointHighlightFill  : '#fff',
        pointHighlightStroke: 'rgba(255,225,70,1)',
        stack               : 'Stack 0',
        data                : [<?php
                              $sumaInicioEnero = 0;
                              $sumaInicioFebrero = 0;
                              ...
                              $sumaInicioJulio = 0;
                              $sumaInicioAgosto = 0;
                              $sumaInicioSeptiembre = 0;
                              $sumaInicioOctubre = 0;
                              $sumaInicioNoviembre = 0;
                              $sumaInicioDiciembre = 0;
                              foreach ($allCajasById as $unaCajaTotal) :
                                list($yearControl, $monthControl, $dayControl) = explode('-', $unaCajaTotal['fecha_inicio']);
                                if ($yearControl == $yearActual) {
                                  if ($monthControl == "01") {
                                    $sumaInicioEnero = $sumaInicioEnero + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "02") {
                                    $sumaInicioFebrero = $sumaInicioFebrero + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "03") {
                                    $sumaInicioMarzo = $sumaInicioMarzo + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "04") {
                                    $sumaInicioAbril = $sumaInicioAbril + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "05") {
                                    $sumaInicioMayo = $sumaInicioMayo + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "06") {
                                    $sumaInicioJunio = $sumaInicioJunio + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "07") {
                                    $sumaInicioJulio = $sumaInicioJulio + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "08") {
                                    $sumaInicioAgosto = $sumaInicioAgosto + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "09") {
                                    $sumaInicioSeptiembre = $sumaInicioSeptiembre + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "10") {
                                    $sumaInicioOctubre = $sumaInicioOctubre + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "11") {
                                    $sumaInicioNoviembre = $sumaInicioNoviembre + $unaCajaTotal['fondo_inicio'];
                                  }
                                  if ($monthControl == "12") {
                                    $sumaInicioDiciembre = $sumaInicioDiciembre + $unaCajaTotal['fondo_inicio'];
                                  }
                                }
                              endforeach;
                              echo $sumaInicioEnero.",".$sumaInicioFebrero.",".$sumaInicioMarzo.",".$sumaInicioAbril.",".$sumaInicioMayo.",".$sumaInicioJunio.",".$sumaInicioJulio.",".$sumaInicioAgosto.",".$sumaInicioSeptiembre.",".$sumaInicioOctubre.",".$sumaInicioNoviembre.",".$sumaInicioDiciembre ;
                            ?>]
      }
          ...
          if (idCaja && monto) {
            if (monto >= 0) {
              agregar_ing = "&idIngreso=" + 0 + "&idCaja=" + idCaja + "&idOrigen=" + selectOrigen + "&idPersonal=" + selectPersonal + "&tipoCliente=" + tipoCliente + "&idCliente=" + selectCliente + "&otroIngreso=" + otroIngreso + "&monto=" + monto + "&fecha=" + date + "&hora=" + hora + "&tipoIngreso=" + selectTipoIngreso + "&idMoneda=" + selectTipoMoneda + "&b=" + 1;
                ...
                $('#btn_cerrar_agregar_ingreso').prop('disabled', true);
                $.ajax({
                  type:"POST",
          ...
          if (idCaja && monto) {
            if (monto >= 0) {
              editar_ing = "&idIngreso=" + idIngreso + "&idCaja=" + idCaja + "&idOrigen=" + selectOrigen + "&idPersonal=" + selectPersonal + "&tipoCliente=" + tipoCliente + "&idCliente=" + selectCliente + "&otroIngreso=" + otroIngreso + "&monto=" + monto + "&fecha=" + date + "&hora=" + hora + "&tipoIngreso=" + selectTipoIngreso + "&idMoneda=" + selectTipoMoneda + "&b=" + 3;
                ...
                $('#btn_cerrar_editar_ingreso').prop('disabled', true);
                //$('#procesando').html('<div class="loader"><br><p style="font-size: 24px;position: absolute;left: 40%;top: 57%;">Procesando, espere por favor...</p></div>');
                $.ajax({
                  type:"POST",
                  url:"cajaMovIngreso.php",
                  data:editar_ing,
...
///////////////////////////////////////////////////////////////////////////////      
    if (o != 1 && p != 1) {
      if (montoEgreso > 0) {
        ...
        $('#btn_cerrar_agregar_egreso').prop('disabled', true);
        //$('#procesando').html('<div class="loader"><br><p style="font-size: 24px;position: absolute;left: 40%;top: 57%;">Procesando, espere por favor...</p></div>');
        $.ajax({
          type:"POST",
...
///////////////////////////////////////////////////////////////////////////////      
    if (o != 1 && p != 1) {
      if (montoEgreso > 0) {
        ...
        $('#btn_editar_egreso').prop('disabled', true);
        $('#btn_cerrar_editar_egreso').prop('disabled', true);
...
function borrarIngreso(id) {
  ...
  if (result) {
    if (id) {
      eliminar_ing = "&idIngreso=" + id + "&idCaja=" + 0 + "&idOrigen=" + 0 + "&idPersonal=" + 0 + "&tipoCliente=" + 0 + "&idCliente=" + 0 + "&otroIngreso=" + 0 + "&monto=" + 0 + "&fecha=" + today + "&hora=" + hora + "&tipoIngreso=" + 0 + "&idMoneda=" + 0 + "&b=" + 2;
      $('#procesando').html('<div class="loader"><br><p style="font-size: 24px;position: absolute;left: 40%;top: 57%;">Procesando, espere por favor...</p></div>');
      $.ajax({
        type:"POST",
        url:"cajaMovIngreso.php",
...
function cambiarCaja(idCajaActual) {
  document.getElementById("btn_cambiar_caja").disabled = true;
  document.getElementById("btn_cerrar_caja").disabled = true;
  document.getElementById("btn_cerrar_modal_gcajas").disabled = true;
      ...
      $.ajax({
        ...
        success:function(r) {
          if (r == 1) {
            ...
            setTimeout(function() {
              alertify.success("Cargando nuevos datos, por favor espere.");
            },1500);
            setInterval('location.reload()', 3500);
            //$("#modalAgregarRepuesto").modal("hide");                    
            //location.reload();                    
          } else {
            document.getElementById("btn_cerrar_caja").disabled = false;
            document.getElementById("btn_cerrar_modal_gcajas").disabled = false;
            document.getElementById("btn_cambiar_caja").disabled = false;
            document.getElementById("btn_eliminar_caja").disabled = false;
            alertify.error("Error.");
          }
        }
      });
    } else {
      alertify.error("Por favor, seleccione una caja.");
      document.getElementById("btn_cerrar_caja").disabled = false;
      document.getElementById("btn_cerrar_modal_gcajas").disabled = false;
      document.getElementById("btn_cambiar_caja").disabled = false;
      document.getElementById("btn_eliminar_caja").disabled = false;
      ...
      $.ajax({
        ...
        success:function(r) {
          if (r == 1) {
            ...
            if (r == 2) {
              alertify.error("Error, No se puede cerrar una caja y abrir una nueva en el mismo mes.\nDebe aguardar a que empiece el próximo mes.");
              //document.getElementById('btn_cerrar_caja').disabled = false;
              document.getElementById('btn_cerrar_modal_gcajas').disabled = false;
              //document.getElementById('btn_cambiar_caja').disabled = false;
              document.getElementById('btn_eliminar_caja').disabled = false;
...
function goInforme() {
  ...
  document.getElementById("btn_cerrar_generar_informe").disabled = true;
  alertify.success("Datos válidos. Generando el informe.");
  setTimeout(function() {
    alertify.success("Por favor espere mientras se carga el informe solicitado.");
    setTimeout(function() {
...
<div id="cargando" class="loader3"></div>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a type="button" id="a_modal_gestion-cajas" class="small-box-footer" data-toggle="modal" data-target="#modal-gestion-cajas" data-id_caja="<?php echo $caja['id'];?>"><input hidden>GESTIONAR CAJAS <i class="fas fa-arrow-circle-right" id="open_modal-gestion-cajas"></i></a>              
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a type="button" id="a_modal_balance" class="small-box-footer" data-toggle="modal" data-target="#modal-balance"><input hidden>INFORMES <i class="fas fa-arrow-circle-right" id="open_modal_balance"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
              ...
              <table id="tabla_egresos" name="tabla_egresos" class="table table-bordered table-striped table-hover" style="font-size: 12px;">
                ...
                <tbody>
                  ...
                  foreach ($result_tipo_conceptos as $unResult_tipo_conceptos2) :
                    ...
                    endforeach; ?>
                    <td class="warning"><?php echo $montoConcept2;?></td>
                    <?php $montoConcept2 = 0 ; ?> 
                  </tr>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-10">
            ...
            $arrayInicioCajaActiva2 = array($partInicioCajaActiva2[0],$partInicioCajaActiva2[1],$partInicioCajaActiva2[2]);
        ...
        <div class="row">
          <div class="col-md-10">
            ...
            <select class="form-control" data-show-subtext="true" data-live-search="true" name="sel_cajas" id="sel_cajas" data-width="100%" onchange="javascript:cajaSeleccionada();" required>
              ...
              $arrayInicio = array($partInicio[0], $partInicio[1], $partInicio[2]);
              $dateInicioOk = implode("-", $arrayInicio);
              $dateCierre = $unaCaja['fecha_cierre'];
              $partCierre = array();
              $partCierre = explode("-",$dateCierre);
              $arrayCierre = array($partCierre[0], $partCierre[1], $partCierre[2]);
          ...
          <div class="col-md-2">
            ...
            <button disabled type="button" id="btn_cambiar_caja" class="btn btn-outline-dark hoverdanger bgroundwhite btn-block" onclick="javascript:cambiarCaja('<?php echo $idCaja ; ?>');" style="border: 1px solid black;">Seleccionar</button>
          </div>
        </div>
        <hr>
        <div class="row">
          <div class="col-md-10">
            ...
            $arrayInicioSinCierre = array($partInicioSinCierre[0], $partInicioSinCierre[1], $partInicioSinCierre[2]);
          ...
          <div class="col-md-2">
            <label for="" class="control-label">Acción:</label>
            <button type="button" id="btn_cerrar_caja" class="btn btn-outline-dark hoverdanger bgroundwhite btn-block" onclick="javascript:cerrarCaja('<?php echo $cajaSinCierre['id']; ?>','<?php echo $balanceSinCierre; ?>');" style="border: 1px solid black;">Dar Cierre</button>
          </div>
        </div>       

      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" id="btn_cerrar_modal_gcajas" class="btn btn-outline-dark hoverdanger" data-dismiss="modal" style="border: 1px solid black;">Cerrar</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content bg-success">
      ...
      <br>
        <div class="row">          
          <div class="col-md-6">            
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_cerrar_agregar_ingreso"  data-dismiss="modal">Cancelar</button>
          </div>
          <div class="col-md-6">                                        
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content bg-danger">
      ...
      <br>
        <div class="row">          
          <div class="col-md-6">            
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_cerrar_agregar_egreso" data-dismiss="modal">Cancelar</button>
          </div>
          <div class="col-md-6">                                        
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <!--  <input type="text" id="start_informe" hidden>
            ...
            <label for="fecha_informe" class="control-label">Rango de informe:</label>
          ...
          <!--<div class="col-md-3">
            <label for="fecha_fin_informe" class="control-label">Hasta fecha:</label>
            <input type="text" class="form-control" name="fecha_fin_informe" id="fecha_fin_informe">
            <script>
              $('#fecha_fin_informe').datepicker({
                isRTL: false,
                format: 'dd-mm-yyyy',
                autoclose: true,
                language: 'es',
       ...
       <div class="modal-footer">
        ...
        <div class="row">          
          <div class="col-md-6">            
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_cerrar_generar_informe"  data-dismiss="modal">Cancelar</button>
          </div>
       <!--   <div class="col-md-6">                                        
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_agregar_egreso">Aceptar</button>
          </div>   -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content bg-success">
      ...
      <br>
        <div class="row">          
          <div class="col-md-6">            
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;"id="btn_cerrar_editar_ingreso" data-dismiss="modal">Cancelar</button>
          </div>
          <div class="col-md-6">                                        
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_editar_ingreso">Aceptar</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content bg-danger">
      ...
      <br>
        <div class="row">          
          <div class="col-md-6">            
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_cerrar_editar_egreso" data-dismiss="modal">Cancelar</button>
          </div>
          <div class="col-md-6">                                        
            <button type="button" class="btn btn-outline-light" style="border: 1px solid white;" id="btn_editar_egreso">Actualizar</button>
          </div>
        </div>
      </div>
    </div>
