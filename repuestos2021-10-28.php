      ...
      if (sumaTotal >= 0) {
        ...
        if (recargo <= 1000) {
          if (completo == 1) {
            ...
            totales = (parseFloat(parcial) + parseFloat(acumRecargo) + parseFloat(grasa) + parseFloat(mano_obra) - parseFloat(senia)).toFixed(2);
            ivaFinal = parseFloat(totales * 0.21).toFixed(2) ;
            totalFinal = (parseFloat(totales) + parseFloat(ivaFinal)).toFixed(2) ;
...
/////////////////////////// SUMAR DATOS CON EL BOTON ELEGIR PROVEEDOR
  function sumarMontoCotizacion(idReparacion,sumaTotal,senia) {
    if (sumaTotal >= 0) {
        var mano_obra = document.getElementById('mano_obra').value;
        var recargo = document.getElementById('recargo').value;
        var grasa = document.getElementById('grasa').value;
            ...
            <table class="table table-bordered table-striped table-hover" style="width: 100%; margin: 0px !important;">
              <thead>
                <tr>
                  ...
                  <th style="vertical-align:middle; width: 11%;" class="text-center">Recargo</th>
                ...
                <tr>
                  <?php
                    if ($cotizacionReparacion) { ?>                      
                      ...
                      <td style="vertical-align:middle; width: 11%;" class="text-center"><input type="number" min="0" max="1000" name="recargo" id="recargo" value="<?php echo $cotizacionReparacion['recargo'];?>" disabled=""><?php echo " %";?></td>
