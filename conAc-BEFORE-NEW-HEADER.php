...
<!-- Solapa de Proyectos -->
  <div id="menu1" class="tab-pane fade in active">
    ...
    <script>
      ...
      function goGestion() {
        var person = prompt("Clave de ingreso:", "Clave..");
        if (person) {
          if (person == "2353") {
            location.replace('reparacion_informes.php');
          } else {
            alertify.error("Lo siento, clave incorrecta.");
          }
        }
      }
...
<!-- Solapa de Máquinas eléctricas -->
  <div id="menu4" class="tab-pane fade">
    <br>
    <a class="btn btn-primary" onclick="javascript:irClientesMe();"><span class="glyphicon glyphicon-plus-sign"></span> <span class="glyphicon glyphicon glyphicon-user"></span> Nuevo Cliente (Máquina Eléctrica)</a>
    ...
    <div class="pull-right">
      <div class="btn-group"><button class="btn btn-info" onclick="javascript:goGestion();"><span class="glyphicon glyphicon-new-window"> </span> Gestión </button></div>&emsp;
